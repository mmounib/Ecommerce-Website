  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <section className='new_arrivals flex w-full flex-col justify-evenly items-center'>
        <h1 className="font-semibold text-4xl md:text-5xl lg:text-6xl">New Arrivals</h1>
        <NewArrivals />
      </section>
      ...
      <section className='bestProducts flex flex-col w-3/4 justify-evenly items-center mb-24'>
        <h1 className="font-semibold text-4xl md:text-5xl lg:text-6xl py-24">Best Selling Products</h1>
        <BestProducts />
      </section>
    </div>
  )
